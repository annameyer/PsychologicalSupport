...
namespace PsychologicalSupports.Controllers
{
    public class Intellectual_9_ClassController : Controller
    {
        ...
        public ActionResult Details(long? id,long? id2)
        {
            ...
            Intellectual_9_Class intellectual_9_Class = db.Intellectual_9_Class.Find(id,id2);
        ...
        public ActionResult Create([Bind(Include = "Intellectual_9_ClassID,StudentID,Profile")] Intellectual_9_Class intellectual_9_Class)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Intellectual_9_ClassID,StudentID,Profile")] Intellectual_9_Class intellectual_9_Class)
        {
            if (ModelState.IsValid)
            {
